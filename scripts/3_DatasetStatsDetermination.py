...
# ------------------------------------------------------
# Use the below script for directory with multiple sub-directories and to find mean and std for all datasets inside the
# folder
# ------------------------------------------------------
...
#     """Loads all images recursively from a folder and its subfolders."""
...
#         if not self.images:
#             raise RuntimeError(f"No images found recursively in {folder}")

#         print(f"Found {len(self.images)} images in {folder} including subfolders")
...
# # ── Config ────────────────────────────────────────────────────────────────────
# TRAIN_DIR = "/workspace/DATASETS/Datasets_VIT"
# BATCH_SIZE = 96
# NUM_WORKERS = 1
# # ─────────────────────────────────────────────────────────────────────────────
...
# dataset = RecursiveImageDataset(TRAIN_DIR, transform=transform)
...
# print(f"\n{'=' * 45}")
# print("AUV Dataset Stats — save these!")
# print(f"{'=' * 45}")
# print(f"mean = [{mean[0]:.4f}, {mean[1]:.4f}, {mean[2]:.4f}]")
# print(f"std  = [{std[0]:.4f},  {std[1]:.4f},  {std[2]:.4f}]")
# print(f"{'=' * 45}")
